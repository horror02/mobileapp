...
import { View, Text, TouchableOpacity, DrawerLayoutAndroid, StyleSheet, Image, Alert } from 'react-native';
...
const Dashboard = ({ navigation }) => {
  ...
  const renderNavigationView = () => (
    <View style={styles.drawerContainer}>
      <TouchableOpacity style={styles.drawerItem} onPress={navigateToHistory}>
